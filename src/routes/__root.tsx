...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Vedbrands is a premium, ultra-modern branding agency website builder." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#f5f6fa" },
      { name: "twitter:title", content: "Vedbrands — We Build Brands That People Remember" },
      { name: "description", content: "Vedbrands is a premium, ultra-modern branding agency website builder." },
      { name: "twitter:description", content: "Vedbrands is a premium, ultra-modern branding agency website builder." },
